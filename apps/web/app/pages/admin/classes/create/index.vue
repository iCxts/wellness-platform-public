      ...
      <div class="space-y-6 pb-4 md:space-y-7">
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:gap-5">
          ...
          >
            <button
              type="button"
              class="h-full w-full rounded-[20px] border border-[rgba(87,84,84,0.17)] p-5 text-left shadow-[0_4px_12px_rgba(0,0,0,0.15)] transition-colors md:min-h-[190px]"
              :class="
                selectedCategory === category
                  ? 'bg-[var(--bw-orange)] text-white'
                  : 'bg-white text-[var(--bw-ink)]'
              "
              @click="selectedCategory = category"
            >
              <div
                class="mb-5 grid h-20 w-20 place-items-center rounded-2xl bg-white/15 text-5xl"
              >
